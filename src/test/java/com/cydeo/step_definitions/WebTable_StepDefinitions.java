...
//    webTableLoginPage.loginButton.click();
 ...
 //    webTableLoginPage.loginWithNoParameter();
 //    webTableLoginPage.loginWithParam(userName, password);
...
//        webTableLoginPage.loginButton.click();
 webTableLoginPage.loginWithParam(credentials.get("username"), credentials.get("password"));
    }
}
